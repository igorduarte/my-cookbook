...
feature 'Visitor view recipes by type' do
  ...
  scenario 'and view only recipes from same type' do
    ...
    expect(page).not_to have_css('div.col-md-6 ul li', text: dessert_recipe.recipe_type.name)
    expect(page).not_to have_css('div.col-md-6 ul li', text: dessert_recipe.cuisine.name)
